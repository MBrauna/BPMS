                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" v-if="opcaoDados">
                                <div class="form-group" v-for="conteudo in listaQuestao" v-bind:key="conteudo.id_pergunta_tipo">
                                    ...
                                    <textarea v-if="conteudo.tipo === 'longtext'" minlength="1" class="form-control form-control-sm" v-bind:placeholder="conteudo.descricao" v-bind:id="'questao_' + conteudo.id_pergunta_tipo" v-bind:name="'questao_' + conteudo.id_pergunta_tipo" required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
