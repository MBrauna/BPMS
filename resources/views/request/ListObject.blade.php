                ...
                <tbody>
                    @foreach ($list as $item)
                        <tr>
                            ...
                            <td><small>{{ consulta_tipo_periodico($item->tipo) ?? 'Nenhum tipo' }}</small></td>
