                                ...
                                <table class="table table-sm table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><small>{{ ($perfil->situacao) ? 'Empresa Ativa' : 'Empresa inativa' }}</small></td>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <form class="modal-content shadow" method="POST" action="{{ route('admin.perfil.cadastrar') }}" autocomplete="off">
                <div class="modal-header bg-primary text-center text-white">
                    <h5 class="modal-title" id="modalPerfilTitulo"><i class="fas fa-pencil-alt"></i> Cadastro de empresas</h5>
                </div>
